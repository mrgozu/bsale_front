...
const mostrarProducto =    (producto)=>{
        ...
        <div class='card  '>
            ...
            <div class="card-body ">
                ...
                <p class="card-text border-top text-center font-weight-bold  ">$${precioMostrado}<button class="btn ml-5 " onclick="agregarPedido()" type="button justify-content-end"><i class="fas fa-cart-plus"></i></button>   </p>
            </div>
